...
while(1):
    ...
    if randint(0,5) == 0: #Object spawning
        ...
        meshItemDict[f"mesh{meshCount}"] = gl.GLMeshItem(meshdata = meshDataDict[f"mesh{meshCount}"], drawFaces = True, drawEdges = False, smooth = True)#, color=(0.5,0.5,0.5,0.1))
