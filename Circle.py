...
from AudioAnalyzerCircle import *
import random
import colorsys
import pygame #import errors occur
...
#filename = "Music/Chill_Rabbit__Modified_Video_Music.mp3"
analyzer = AudioAnalyzer()
#analyzer.load(filename)

filenameinput = input("Input filename/file path: ")
try:
    filename = filenameinput if filenameinput != "" else "Music/Chill_Rabbit__Modified_Video_Music.mp3"
    analyzer.load(filename)
except:
    filename = "Music/Chill_Rabbit__Modified_Video_Music.mp3"
    analyzer.load(filename)
